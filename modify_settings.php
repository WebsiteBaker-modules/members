        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td align="left">
                        ...
                        <input class="btn w3-blue-wb w3-hover-green w3-round-small" name="save" type="submit" value="<?php echo $TEXT['SAVE']; ?>" style="width: 100px; margin-top: 5px;" />
                        <input class="btn w3-blue-wb w3-hover-green w3-round-small" name="save" type="submit" value="<?php echo $METEXT['SAVE_FINISH']; ?>" style="width: 150px; margin-top: 5px;" onclick="document.getElementById('gobacktolist').value = '1';"/>
                </td>
                        <td align="right">
