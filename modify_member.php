...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
                <td align="left">
                        ...
                        <input name="save" type="submit" value="<?php echo $METEXT['SAVE_FINISH']; ?>" style="margin-top: 5px;"  class="btn w3-blue-wb w3-hover-green w3-round-small"  onclick="document.getElementById('gobacktolist').value = '1';"/>
                        <input name="save" type="submit" value="<?php echo $METEXT['SAVE_DUPLICATE']; ?>"   class="btn w3-blue-wb w3-hover-green w3-round-small" style="width: 100px; margin-top: 5px; margin-left:50px" onclick="document.getElementById('doduplicate').value = '1';"/>
                </td>
                <td align="right">
                        <input type="button"  class="btn w3-blue-wb w3-hover-green w3-round-small" value="<?php echo $TEXT['CANCEL']; ?>" onclick="javascript: window.location = '<?php
